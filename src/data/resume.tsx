  ...
  work: [
    {
      ...
      description: [
        "Architecting and developing AI-powered solutions for the Vero team using LangGraph.",
        "Building robust and scalable backends with Ruby on Rails and FastAPI.",
        "Developing responsive and interactive frontend interfaces using React.",
        "Managing cloud infrastructure and CI/CD build pipelines on Google Cloud Platform (GCP).",
      ],
    },
    {
      company: "Liten Media",
    ...
    },
    {
      ...
      description: [
        "Partnered with 75+ clients from 17 countries, delivering web solutions that align with diverse business goals and user needs.",
